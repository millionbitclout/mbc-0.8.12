...
EVENTS: Dict[int, Dict[str, Union[Alert, AlertCallbackType]]] = {
  ...
  EventName.steerTempUnavailableSilent: {
    ET.WARNING: Alert(
      ...
      "Please Resume Manual Steering Temporarily",
      AlertStatus.userPrompt, AlertSize.small,
  ...
  EventName.preDriverDistracted: {
    ET.WARNING: Alert(
      ...
      "Check Front IR Camera Settings",
      AlertStatus.normal, AlertSize.small,
  ...
  EventName.driverDistracted: {
    ET.WARNING: Alert(
      ...
      "Driver Distracted",
      AlertStatus.userPrompt, AlertSize.mid,
      Priority.MID, VisualAlert.steerRequired, AudibleAlert.disengage, .1),
  },
  ...
  EventName.manualLongitudinalRequired: {
    ET.WARNING: Alert(
      "Adaptive Cruise Control turned off",
  ...
  EventName.steerSaturated: {
    ET.WARNING: Alert(
      "Sharp Turn",
      "Torque Limit, Please Be Mindful",
      AlertStatus.userPrompt, AlertSize.mid,
  ...
  EventName.silentPedalPressed: {
    ET.USER_DISABLE: Alert(
      ...
      AlertStatus.normal, AlertSize.none,
      Priority.MID, VisualAlert.none, AudibleAlert.none, .2),
    ET.NO_ENTRY: NoEntryAlert("Nickg773- test, foot on pedal",
                              visual_alert=VisualAlert.brakePressed),
  },
  ...
  EventName.steerTempUnavailable: {
    ...
    ET.NO_ENTRY: NoEntryAlert("Take over temprorarily"),
  },
  ...
  EventName.tooDistracted: {
    ET.NO_ENTRY: NoEntryAlert("Distracted or Camera Issue - Please Check"),
  },
  ...
  EventName.wrongGear: {
    ET.SOFT_DISABLE: user_soft_disable_alert("Gear is not D"),
    ET.NO_ENTRY: NoEntryAlert("Gear is not D"),
  },

  EventName.silentWrongGear: {
    ET.SOFT_DISABLE: Alert(
      "Gear not D",
      "openpilot is off until gear is back to D",
      AlertStatus.normal, AlertSize.mid,
  ...
  EventName.seatbeltNotLatched: {
    ET.SOFT_DISABLE: user_soft_disable_alert("Seatbelt unbuckled"),
  ...
  EventName.controlsMismatch: {
    ET.IMMEDIATE_DISABLE: ImmediateDisableAlert("Controls Mismatch / Restart the Car?"),
  },
  ...
  EventName.reverseGear: {
    ...
    ET.USER_DISABLE: ImmediateDisableAlert("Pay Attention To Back"),
    ET.NO_ENTRY: NoEntryAlert("You're in reverse. Pat attention."),
  },

  # On cars that use stock ACC the car can decide to cancel ACC for various reasons.
  # When this happens we can no long control the car so the user needs to be warned immediately.
  EventName.cruiseDisabled: {
    ET.IMMEDIATE_DISABLE: ImmediateDisableAlert("Cruise Has Been Turned Off"),
  },
