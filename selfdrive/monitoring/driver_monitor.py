...
class DRIVER_MONITOR_SETTINGS():
  def __init__(self, TICI=TICI, DT_DMON=DT_DMON):
    ...
    self._DISTRACTED_TIME = 25. # active monitoring total timeout
    ...
    self._POSE_CALIB_MIN_SPEED = 18  # <<30 mph>>
    ...
    self._MAX_TERMINAL_ALERTS = 5  # not allowed to engage after 5 terminal alerts
    self._MAX_TERMINAL_DURATION = int(50 / self._DT_DMON)  # not allowed to engage after 50s of terminal alerts
